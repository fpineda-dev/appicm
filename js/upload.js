...
Array.from(files).forEach(
    f => {
        ...
        //span_name.style.width = (span_text.clientWidth - 20)+'px'; //calc(200px - 100%);
        const parentElement = span_name.parentElement;
        const parentWith = parentElement.offsetWidth;
        const calculateWith = parentWith / 2;

        span_name.style.width = calculateWith + 'px'
